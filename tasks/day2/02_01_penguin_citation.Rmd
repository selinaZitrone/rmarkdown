...
Take 5-10 minutes and explore the visual editor. If you want, you can try to e.g.,
...
#### Add Gorman et al. (2014) via visual editor

First, we will cite the original paper that published and analysed the penguin data
...
Before inserting the citation, have a close look at the options that the
...
#### Add `palmerpenguins` citation

Now let's use a different method to add a second citation of the `palmerpenguins` package. 
