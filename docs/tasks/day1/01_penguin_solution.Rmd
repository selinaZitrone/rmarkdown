...
```{r include-penguins, out.width="60%", fig.align = "center", fig.cap="Illustration of the three penguin species by Allison Horst"}`r ''`
...
fig.width=4, fig.height=3, fig.align='center', echo=TRUE}
...
```{r scatterplot-bill, fig.cap="Scatter plot with regression lines
showing the relationship between bill length and bill depth for the 3 penguin species", echo=TRUE}
ggplot(
  data = penguins,
  aes(
    x = bill_length_mm,
