...
You can either reproduce my text (copy paste to type less), or you can write your own text about penguins.

The point of this task is to include many different markdown formatting elements.

You can find the links that I used in the text below in the `Links` tab.
