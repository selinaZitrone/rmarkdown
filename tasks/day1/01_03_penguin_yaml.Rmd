We will no add some additional `YAML` metadata and document options
to the document.
...
Also here, knit often, to see the difference that the options make to the document
and to make sure that there is no but.
