...
```{r histogram-flipper, fig.cap="Histogram of weight of the three penguin species.", fig.width=4, fig.height=3, fig.align='center'}
...
The linear model analysis shows that both bill length and species have a significant effect on 
the bill depth of the penguins.
