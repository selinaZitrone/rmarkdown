...
# over the size of it
# This only works if you have the file stored locally in a folder called /img
...
```{r histogram-weight, fig.cap="Histogram of weight of the three penguin species.", fig.width=4, fig.height=3, fig.align='center', echo=TRUE}
...
```{r scatterplot-bill, fig.cap="Scatter plot with regression lines showing the relationship between bill length and bill depth for the 3 penguin species", echo=TRUE}
ggplot(
  data = penguins,
  aes(
    x = bill_length_mm,
