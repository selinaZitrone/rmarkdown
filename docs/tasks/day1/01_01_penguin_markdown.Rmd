...
Start writing your own paper about the 3 penguins. 

First, remove all template text from the template document **except** the YAML header and the first code chunk (we will learn later what that does).
...
So you can copy paste my text and add the formatting elements. Find the links that I used
...
`Write with Markdown` section of the R Markdown cheat sheet to find examples for more
