...
The mean weight of all penguin species is `r round(mean(penguins$body_mass_g, na.rm = TRUE), 0)` g. *Gentoo* penguins have an average weight of `r round(gentoo_mean,0)` g, *Adelie* penguins of `r round(adelie_mean, 0)` g and *Chinstrap* penguins of `r round(chinstrap_mean, 0)` g.
